...
use oxc_ast::{
    AstKind,
    ast::{
        IdentifierName, PropertyKey, StringLiteral, TSInterfaceDeclaration, TSLiteral,
        TSLiteralType, TSMappedTypeModifierOperator, TSPropertySignature, TSSignature, TSType,
